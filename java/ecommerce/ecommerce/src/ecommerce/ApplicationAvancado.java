 ...
 */
	...
	public static void desejaContinuar() {
		...
		// Método equalsIgnoreCase vai referenciar a variavel ignorando se é maiuscula
		// ou minuscula
	...
	/*
	 * FUNÇÃO RESET - FUNÇÃO PRECISOU! public static void getReset() { Scanner mySc
	 ...
	 */
	/*
	 * NÃO PRECISOU public static void getErp() {
	 * 
	 * 
